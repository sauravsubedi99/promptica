...
const TermsOfService = () => {
  return (
      ...
      <div className="w-full max-w-2xl mx-auto bg-white rounded-xl shadow-md p-8 space-y-6">
        ...
        <H4  weight="bold" color="gray-900">Disclaimer on AI Responses</H4>
        <p className="text-sm text-gray-700 space-y-2">Our platform may provide responses generated by artificial intelligence. While we strive for accuracy and helpfulness, we cannot guarantee that AI-generated content will always be correct, complete, or up to date. You should not rely solely on such responses for making decisions, and you are encouraged to verify any information independently.</p>
      </div>
